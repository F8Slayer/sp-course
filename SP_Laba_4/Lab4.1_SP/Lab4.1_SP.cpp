...
int main(int argc, char* argv[])
{
	...
	if (strcmp(argv[1], "-a") == 0) {
		(pack_files()) ? printf("Good!\nThe files were archived.") : printf("The files were not archived.");
	} else {
		(unpack_files()) ? printf("Good!\nThe files were unziped.") : printf("The files were not unziped.");
	}
	return 0;
}
